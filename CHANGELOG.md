...
## [0.13.6](https://github.com/leandrocp/mdex/compare/v0.13.5...v0.13.6) (2026-09-10)
...
* require mdex_native >= 0.2.6

### Features

* update mdex_native and comrak ([#377](https://github.com/leandrocp/mdex/issues/377)) ([7739bf5](https://github.com/leandrocp/mdex/commit/7739bf5f51c609dd927905efb2939eaebf61d1b3)) and ([#382](https://github.com/leandrocp/mdex/issues/382)) ([f782966](https://github.com/leandrocp/mdex/commit/f782966f379a0d92f4543331af58e07be4bc43dc))
  - Add LaTeX-style math delimiters with `extension: [math_latex: true]`.
  - Add attribute parsing for headings, fenced code blocks, inline code, links, and images. Enable it with the `:header_attributes`, `:fenced_code_attributes`, `:inline_code_attributes`, and `:link_attributes` extension options. Parsed attributes are available in the document AST as `%MDEx.Attributes{}`.
  - Add semantic HTML for alerts with `render: [alert_style: :semantic]`.
  - Heading anchors generated by `:header_id_prefix` now appear after the heading content, include an accessible `aria-label`, and are no longer hidden from assistive technology.

* update lumis ([#377](https://github.com/leandrocp/mdex/issues/377)) ([7739bf5](https://github.com/leandrocp/mdex/commit/7739bf5f51c609dd927905efb2939eaebf61d1b3))

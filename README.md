...
Convert between AST, Markdown, HTML, and XML.
...
Formatting is the process of converting from one format to another, mostly from AST or Markdown to HTML,
but to XML and to Markdown is also supported.

Use [parse_document/2](https://hexdocs.pm/mdex/MDEx.html#parse_document/2) to generate an AST or the `to_*` functions

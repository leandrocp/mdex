...
use autumnus_adapter::{AutumnusAdapter, AutumnusAdapterBuilder};
...
fn markdown_to_html_with_options<'a>(
    ...
    let autumnus_adapter = AutumnusAdapterBuilder::new()
        .theme(options.features.syntax_highlight_theme.clone())
        .inline(options.features.syntax_highlight_inline_style)
        .build();

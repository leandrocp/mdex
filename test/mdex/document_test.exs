defmodule MDEx.DocumentTest do
  ...
  describe "Access behaviour" do
    ...
    test "access with complex function selectors" do
      # Function that checks multiple criteria
      complex_selector = fn
    ...
    test "access nested document operations" do
      # Test deeply nested access patterns
      nested_doc = ~MD"""
      # Main
      > Quote level 1
      >> Quote level 2
    ...
    test "get_and_update function edge cases" do
      # Function that returns invalid update result
  ...
  describe "Enumerable protocol" do
    test "empty document enumeration" do
      ...
      # Empty document still contains the document itself
    ...
    test "enumeration with early termination" do
      # Test that Enum.find stops at first match
      first_text =
    ...
    test "slice behavior for enumeration" do
      # Test Enum.slice which uses the slice/1 callback
  ...
  describe "Enum.at/3" do
    ...
    test "negative index behavior" do
      # Negative indices should work according to Enum.at/2 semantics
  ...
  describe "Collectable protocol" do
    ...
    test "collectable protocol error handling" do
      # Test what happens with invalid collection elements

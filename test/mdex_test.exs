  ...
  describe "syntax highlighting" do
    test "enabled by default" do
      assert_output(
        ...
        <code class="language-elixir" translate="no"><span class="" style="color: #ABB2BF;">{</span><span class="string" style="color: #98C379;">:mdex</span><span class="" style="color: #ABB2BF;">,</span> <span class="string" style="color: #98C379;">&quot;~&gt; 0.1&quot;</span><span class="" style="color: #ABB2BF;">}</span>
        </code></pre>
        """
      )
    end
    ...
    test "with invalid lang" do
      assert_output(
        ...
        ~s"""
        <pre class="autumn highlight" style="background-color: #282C34; color: #ABB2BF;">
        <code class="language-invalid" translate="no">{:mdex, &quot;~&gt; 0.1&quot;}
        </code></pre>
        """
      )
    end
